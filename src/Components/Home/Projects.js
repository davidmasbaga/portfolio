...
function Projects() {
  return (
    ...
    <ProjectCard tech='NextJs' name= "Notes to Notion" image="https://res.cloudinary.com/dkxlwv844/image/upload/v1682345100/Notes_to_Notion_en0znz.jpg" gitHub="https://github.com/davidmasbaga/notion_quick"/>
